    ...
    columns = [
        {
            ...
            render(status) {
                ...
                return (
                    <div className={'middle-inline_group'}>
        ...
        },
        {
            ...
            dataIndex: 'username',
            render: (name, user) => (
                <Authorized route={SYSTEM_USER_UPDATE} noMatch={name}>
            ...
            render: (val, user) => (
                <div className={'link-group'}>
                    ...
                    <Authorized route={SYSTEM_USER_STATUS}>
                        <Popconfirm
                            title={<FormattedMessage
                                id={'Page.system.users.edit.setStatusConfirm'}
                                values={{
                        ...
                        >
                            <a>{user.status == 1 ? <FormattedMessage id={'Common.message.disable'}/> :
                                <FormattedMessage id={'Common.message.enable'}/>}
                            </a>
                        </Popconfirm>
                    </Authorized>
