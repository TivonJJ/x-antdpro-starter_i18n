            ...
            <Form onSubmit={this.submit}>
                <Form.Item {...formItemLayout}>
                    {getFieldDecorator('password', {
                        ...
                        <Input
                            type={"password"}
                            placeholder={formatMessage({id:'Page.changePassword.oldPassword.placeholder'})}
                        />
                    )}
                </Form.Item>
                <Form.Item {...formItemLayout}>
                    {getFieldDecorator('new_password', {
                        ...
                        <Input
                            type={"password"}
                            placeholder={formatMessage({id:'Page.changePassword.newPassword.placeholder'})}
                        />
                    )}
                </Form.Item>
                <Form.Item {...formItemLayout}>
                    {getFieldDecorator('re_new_password', {
                        ...
                        <Input
                            type={"password"}
                            placeholder={formatMessage({id:'Page.changePassword.confirmPassword.placeholder'})}
                        />
                    )}
                </Form.Item>
                <Form.Item>
